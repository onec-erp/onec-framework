 ...
 * counterpart of {@link com.onec.posting.DocumentPostedEvent}. It deliberately ships with <em>no
 * consumers</em>: delivery (in-app notifications, the cross-node event bus, {@code onec-mail-starter})
