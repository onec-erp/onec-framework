...
public record MentionRef(String kind, String name, UUID id) {
    ...
    /** The {@link com.onec.ui.UiAccessService} entity type for this kind: {@code "catalog"}/{@code "document"}. */
    public String accessType() {
        return "catalogs".equals(kind) ? "catalog" : "document";
    }

    /** The {@code kind/name/id} route segment, the body of an {@code onec://} navigation url. */
    public String route() {
        return kind + "/" + name + "/" + id;
    }
}
