 ...
 * the {@code onec.media.*} namespace.
 */
@ConfigurationProperties(prefix = "onec.media")
public class MediaProperties {
    ...
    public static class Filesystem {
        /**
         * Directory the filesystem backend writes uploads beneath. Defaults to {@code onec-media}
         * under the JVM temp dir; set an absolute, persistent path in production.
         */
        private String directory = System.getProperty("java.io.tmpdir") + "/onec-media";
