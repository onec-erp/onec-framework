 ...
 * endpoint and the storage are gated on {@code onec.media.enabled} (default true) and a servlet web
 ...
 * (sized from {@code onec.media.max-file-size}) wins over the 1&nbsp;MB container default that would
...
@ConditionalOnProperty(prefix = "onec.media", name = "enabled", havingValue = "true", matchIfMissing = true)
