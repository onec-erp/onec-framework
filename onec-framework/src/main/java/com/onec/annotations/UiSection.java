 ...
 *
 * @deprecated Assign entities to sidebar sections via {@code UiLayoutBuilder}
 * in your {@code OneCUiConfigurer} instead, e.g.
 * {@snippet :
 *   layout.section("Sales").order(0).icon("euro")
 *           .document(Invoice.class)
 *           .catalog(Customer.class);
 * }
 * The configurer is the source of truth for the sidebar (served at
